  ...
  <div class="p-4 md:p-6 bg-white rounded-lg shadow-sm">
      ...
      >
        ...
        <el-table-column prop="account" label="账户" min-width="140" :show-overflow-tooltip="true">
          <template #default="{ row }">
            <span class="font-medium text-gray-900">{{ row.account }}</span>
          </template>
        </el-table-column>
        ...
        >
          <template #default="{ row }">
            <span class="text-gray-600">{{ row.addTime }}</span>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="{ row }">
            <span class="text-gray-600">{{ row.statusUpdateTime }}</span>
          </template>
        </el-table-column>
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mt-4 md:mt-6 px-1 md:px-2">
      <div class="flex items-center gap-3 md:gap-4">
        ...
        <el-select v-model="pageSize" class="w-[100px]" size="small">
